...
confirmed_cases_worldwide <- read_csv("documents/confirmed_cases_worldwide.csv")
glimpse(confirmed_cases_worldwide)
ggplot(confirmed_cases_worldwide, aes(x = date, y = cum_cases))+
  geom_line() +
  ylab("Cumulative confirmed cases")
# Read in datasets/confirmed_cases_china_vs_world.csv
confirmed_cases_china_vs_world <- read_csv("documents/confirmed_cases_china_vs_world.csv")
...
confirmed_cases_by_country <- read_csv("documents/confirmed_cases_by_country.csv")
...
confirmed_cases_top7_outside_china = read_csv("documents/confirmed_cases_top7_outside_china.csv")
